...
namespace Selfaware.Features.Game.Lobby
{
    ...
    public class LobbyController : ControllerBase
    {
        ...
        public async Task<ActionResult> JoinLobby([FromBody] JoinLobbyDto dto)
        {
            ...
            {
                return BadRequest(
                    CustomResponse<string>.ErrorResponse("Enter nickName to join lobby")
                );
            }
            ...
            return Ok(
                CustomResponse<GetLobbyPlayerDto>.SuccessResponse(result.Data, result.Message)
            );
        }

        [HttpGet("{joinCode}/{playerId:guid}")]
        public async Task<ActionResult> GetLobbyForPlayer(
        ...
        )
        {
            ...
            return Ok(
                CustomResponse<GetLobbyForPlayerDto>.SuccessResponse(
                    result.Data,
                    "Lobby found succesfully"
                )
            );
        }
    }
